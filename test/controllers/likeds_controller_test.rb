...
class LikedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create liked" do
    assert_difference('Liked.count') do
      post likeds_url, params: { liked: { user_id: @liked.user_id, user_post_id: @liked.user_post_id } }
    end
  ...
  test "should update liked" do
    patch liked_url(@liked), params: { liked: { user_id: @liked.user_id, user_post_id: @liked.user_post_id } }
